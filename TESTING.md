...
| **PROFILE PAGE** |||||
| Edit Username button | Click button to edit your username | User updates the username and click Save Username | The site reloads and a success messages is shown | Pass |
